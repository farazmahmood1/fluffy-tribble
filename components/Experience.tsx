...
const ExperienceItem: React.FC<{ exp: Experience; index: number }> = ({ exp, index }) => {
  ...
  return (
    ...
    >
      <div className="py-12 md:py-16 px-4 md:px-0 flex flex-col justify-between cursor-pointer transition-all duration-500">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-full">
          <div className="flex-1">
            ...
            <h3 className="text-3xl md:text-5xl lg:text-6xl font-syne font-bold tracking-tight group-hover:pl-4 transition-all duration-500 leading-none">
              {exp.role}
            </h3>
            <p className="text-lg md:text-xl opacity-40 mt-4 font-medium tracking-tight italic">{exp.company}</p>
          </div>
              ...
              <ul className="space-y-3 max-w-4xl border-l border-[#d9ff3f] pl-6 ml-1">
                {exp.description.map((bullet, i) => (
                  <motion.li 
                    ...
                    className="text-sm md:text-base text-black/60 font-light leading-relaxed flex items-start gap-3"
                  >
...
const ExperienceSection: React.FC = () => {
  return (
    <section id="experience" className="py-60 px-8 lg:px-24 bg-[#e5e5e5] relative z-20">
      <div className="max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 items-end mb-40 gap-y-10">
          <div className="md:col-span-8">
            ...
            <motion.h3 
              ...
              viewport={{ once: true }}
              className="text-7xl md:text-[11vw] font-syne font-bold tracking-tighter leading-[0.8]"
            >
              WORK
            </motion.h3>
          </div>
          <div className="md:col-span-4 md:text-right md:pb-4">
            <motion.p 
              ...
              viewport={{ once: true }}
              className="text-lg font-medium max-w-[280px] md:ml-auto leading-tight"
            >
